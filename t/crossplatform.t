 ...
 SKIP:
  {
    ...
    skip_subtests "Can't load $module", $tests_per_platform
      if $@;
    ...
    ok $module->file_name_is_absolute($base), 1, "$base is absolute on $platform";
    ...
    ok $module->abs2rel($file, $base), $result, "$platform->abs2rel($file, $base)";
